import { Button, Card, Text, Title, ActionIcon, Modal, Flex, } from "@mantine/core"
import React, { useState } from "react"

import { LatestExpensesContext } from "./home/context/LatestExpensesContext";

import { IconPizza, IconShoppingCart, IconBallBowling, IconPlus } from '@tabler/icons-react';
      ...
      <LatestExpensesContext.Provider value={latestExpenses}>
         ...
         <div className="home-section-container w-full h-full flex">
            <div className="home-left-section w-1/3 h-full p-3 flex flex-col gap-4">
               ...
               <div className="home-today-expenses flex flex-col max-h-1/4 gap-3">
                  {
               ...
               <div className="home-yesterday-expenses flex flex-col max-h-1/4 gap-3">
               {
                     latestExpenses.map((exp, index) => {
            ...
            <div className="home-right-section w-2/3 h-full bg-orange-500">
